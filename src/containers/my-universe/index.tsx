    ...
    <div className="w-full flex flex-col-reverse lg:flex-row justify-between items-center gap-20 px-2 md:px-6">
      <div className="flex-1 relative w-full lg:w-auto">
        ...
        <div className="text-lg text-zinc-600 dark:text-zinc-400 my-6 md:my-10 font-bold">
          ...
          Crafting intelligent, scalable systems and delightful user experiences at the intersection of AI and web tech 💡💻
...
export function CompareDemo() {
  return (
    <div className="w-full border rounded-3xl dark:bg-neutral-900 bg-neutral-100 border-neutral-200 dark:border-neutral-800">
      <img
        src="/avatar/1.png" // Update this path to your photo's location
        alt="Your Name"
        className="object-cover object-center h-[200px] sm:h-[250px] md:h-[400px] lg:h-[500px] w-full"
      />
    </div>
  )
}
...
export const Title = memo(() => {
  return (
    <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold tracking-tight sm:my-6 dark:text-zinc-300 text-zinc-700">
      I&apos;m <Cover>Phong Thanh Lu</Cover>
    </h1>
  )
})
