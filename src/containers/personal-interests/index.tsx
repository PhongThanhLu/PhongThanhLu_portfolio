  ...
  return (
    ...
    >
      <EvervaultCard
        text={
          <a
            href="/files/Phong_Thanh_Lu_resume.pdf"
            download
...
const items = [
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        From deep focus to feel-good vibes, my YouTube playlists fuel my coding sessions
        — check out my curated collection of tracks that keep me productive.
      </span>
    ),
